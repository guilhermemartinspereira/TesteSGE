...
public class ConhecimentoDeDominioDeInterfaceWeb {
	...
	public ConhecimentoDeDominioDeInterfaceWeb() {
		...
		mapa.put("mensagem.editarErro", "Alguns campos est�o com erros");
		mapa.put("mensagem.criarErro", "Alguns campos est�o com erros");
		mapa.put("mensagem.editarSucesso", "Consigna��o salva com sucesso");
		mapa.put("mensagem.criarSucesso", "Consigna��o criada com sucesso");
