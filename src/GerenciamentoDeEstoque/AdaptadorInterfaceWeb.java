...
public class AdaptadorInterfaceWeb implements Adaptador {
	...
	public void executarEventoCriar(ContextoGerenciamentoDeEstoque contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de cria��o? ", conhecimento.get("titulo." + Estado.CriandoEstoque.toString()), driver.getTitle());
	...
	public void executarEventoEditar(ContextoGerenciamentoDeEstoque contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de edi��o? ", conhecimento.get("titulo." + Estado.EditandoEstoque.toString()), driver.getTitle());
	...
	public void executarEventoBuscar(ContextoGerenciamentoDeEstoque contexto) {
		try {
			...
			Assert.assertEquals("O t�tulo continuou igual? ", conhecimento.get("titulo." + Estado.ListandoEstoque.toString()), driver.getTitle());
	...
	private void executarEventoCancelar(ContextoGerenciamentoDeEstoque contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de listagem? ", conhecimento.get("titulo." + Estado.ListandoEstoque.toString()), driver.getTitle());
	...
	private void executarEventoSalvarDadosSucesso(ContextoGerenciamentoDeEstoque contexto, String seletorMensagem) {
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o de listagem? ", conhecimento.get("titulo." + Estado.ListandoEstoque), driver.getTitle());
