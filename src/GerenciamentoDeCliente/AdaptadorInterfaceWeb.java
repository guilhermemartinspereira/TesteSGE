...
//			Assert.assertEquals("O t�tulo mudou para o da tela de cria��o? ", conhecimento.get("titulo." + Estado.CriandoCliente.toString()), driver.getTitle());
...
//			Assert.assertEquals("O t�tulo mudou para o da tela de edi��o? ", conhecimento.get("titulo." + Estado.EditandoCliente.toString()), driver.getTitle());
...
//			Assert.assertEquals("O t�tulo continuou igual? ", conhecimento.get("titulo." + Estado.ListandoClientes.toString()), driver.getTitle());
...
//			Assert.assertEquals("O t�tulo mudou para o da tela de listagem? ", conhecimento.get("titulo." + Estado.ListandoClientes.toString()), driver.getTitle());
...
//			Assert.assertEquals("O t�tulo continuou igual? ", conhecimento.get("titulo." + estado.toString()), driver.getTitle());
...
//			Assert.assertEquals("O t�tulo mudou para o de listagem? ", conhecimento.get("titulo." + Estado.ListandoClientes), driver.getTitle());
