...
public class AdaptadorInterfaceWeb implements Adaptador {
	...
	public void executarEventoCriar(ContextoGerenciamentoDeItem contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de cria��o? ", conhecimento.get("titulo." + Estado.CriandoItem.toString()), driver.getTitle());
	...
	public void executarEventoEditar(ContextoGerenciamentoDeItem contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de edi��o? ", conhecimento.get("titulo." + Estado.EditandoItem.toString()), driver.getTitle());
	...
	public void executarEventoBuscar(ContextoGerenciamentoDeItem contexto) {
		try {
			...
			Assert.assertEquals("O t�tulo continuou igual? ", conhecimento.get("titulo." + Estado.ListandoItem.toString()), driver.getTitle());
	...
	private void executarEventoCancelar(ContextoGerenciamentoDeItem contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de listagem? ", conhecimento.get("titulo." + Estado.ListandoItem.toString()), driver.getTitle());
	...
	private void executarEventoSalvarDadosSucesso(ContextoGerenciamentoDeItem contexto, String seletorMensagem) {
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o de listagem? ", conhecimento.get("titulo." + Estado.ListandoItem), driver.getTitle());
