...
//			Assert.assertEquals("O t�tulo mudou para o da tela do estoque? ", conhecimento.get("titulo." + Estado.GerenciandoItens.toString()), driver.getTitle());
	...
	public void executarEventoGerenciarItemExistente(ContextoEntradaSaidaDeEstoque contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de gerenciamento de item existente? ", conhecimento.get("titulo." + Estado.IncrementandoDecrementandoQuantidade.toString()), driver.getTitle());
	...
	public void executarEventoRemover(ContextoEntradaSaidaDeEstoque contexto) {
		...
		try {
			...
			if(contexto.quantidade > 0) {
				Assert.assertEquals("O t�tulo mudou para o da tela de gerenciamento de itens? ", conhecimento.get("titulo." + Estado.GerenciandoItens.toString()), driver.getTitle());
				...
				Assert.assertEquals("O t�tulo continua igual? ", conhecimento.get("titulo." + Estado.IncrementandoDecrementandoQuantidade.toString()), driver.getTitle());
	...
	public void executarEventoAdicionar(ContextoEntradaSaidaDeEstoque contexto) {
		...
		try {
			...
			if(contexto.quantidade > 0) {
				...
				Assert.assertEquals("O t�tulo continua igual? ", conhecimento.get("titulo." + aux.toString()), driver.getTitle());
	...
	public void executarEventoCancelar(ContextoEntradaSaidaDeEstoque contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de gerenciamento de item existente? ", conhecimento.get("titulo." + Estado.GerenciandoItens.toString()), driver.getTitle());
	...
	public void executarEventoBuscar(ContextoEntradaSaidaDeEstoque contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo continuou igual? ", conhecimento.get("titulo." + Estado.ListandoEstoques.toString()), driver.getTitle());
	...
	public void executarEventoVoltar(ContextoEntradaSaidaDeEstoque contexto) {
		...
		try {
			...
			Assert.assertEquals("O t�tulo mudou para o da tela de lista de estoques? ", conhecimento.get("titulo." + Estado.ListandoEstoques.toString()), driver.getTitle());
